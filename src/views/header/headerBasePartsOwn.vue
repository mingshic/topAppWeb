...
<template>
  <div class="headerView">
    ...
    <template v-if="popBg">
      <div class="popBg">
        <search-parts-own-list @change="updatePopBg" @search="searchData" :queryData="queryData"></search-parts-own-list>
      </div>
    </template>
  </div>
</template>
...
<script>
import searchPartsOwnList from '@/components/searchPartsOwnList'
export default {
  name: 'headerBasePartsOwn',
