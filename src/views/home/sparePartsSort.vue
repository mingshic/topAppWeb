<template>
    <div class="sparePartsSortOutSelectView">
            ...
            <el-table :data="spareData.DATA" style="width: 100%">
                                ...
                                <el-form label-width="1rem">
                                    ...
                                    <el-form-item label="备件类型">
                                        <el-select v-model="scope.row.typeName" placeholder="请选择备件类型" clearable>
                                            <el-option v-for="itemParts in partstList" :label="itemParts.partsTypeName" :value="itemParts.partsTypeId" :key="itemParts.id"></el-option>
                                        </el-select>
                                    </el-form-item>
